...
class JParametrosCaja extends JPanel
{
    ...
    // para las fuentes...
    private Font oldFont = getFont();
    private Font newFont = new Font("Monospaced", Font.BOLD, oldFont.getSize());
    // creo la ventana
	...
	private static void dibujarLinea(Graphics g, int x1, int y1, int x2, int y2, int thickness, Color c){
